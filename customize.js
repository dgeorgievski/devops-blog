...
const config = {
  /* Site
  ========================================= */
  title: `Uneducated DevOps`,           // Displayed in header
  description: `Experiences are unique and knowledge is for sharing`,   // Site description
  maxWidth: "768px",                  // Max width of website
  enableAbout: true,                  // Enables about page
  siteUrl: `https://3bunara.xyz`, // For sitemap & RSS feed
  useScrollIndicator: true,           // Use scroll indicator on top of screen in posts

  /* Profile
  ========================================= */
  author: `Dimitar Georgievski`,                     // Name shows on profile
  profileDescription: "Uneducated DevOps",   // Shows under author name
